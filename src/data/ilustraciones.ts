// Ilustraciones sintéticas por temporada y misión (generadas para el prototipo).
...
export const ilustracionTemporada: Record<string, string> = { t1, t2, t3, t4, t5 };
export const ilustracionMision: Record<string, string> = { m1, m2, m3, m4, m5 };