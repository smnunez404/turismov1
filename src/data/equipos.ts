...
export const rivales: Rival[] = [
  {
    ...
    avatarId: "canoto",
    destreza: 0.55,
    frase: "Dale pues, a ver quién sabe más de su tierra.",
  },
  {
    id: "rv2",
    ...
    avatarId: "tucan",
    destreza: 0.7,
    frase: "Aviso: soy fanática de la Chiquitania.",
  },
  {
    id: "rv3",
    nombre: "Diego Peña",
    avatarId: "jaguar",
    destreza: 0.45,
    frase: "Juego tranquilo, pero no me dejo ganar.",
  },
  {
    id: "rv4",
    nombre: "Mariana Roca",
    avatarId: "sao",
    destreza: 0.62,
    frase: "Gastronomía es lo mío, cuidate.",
  },
];
