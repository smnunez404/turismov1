...
function PortadaMision() {
  ...
  return (
    <Pantalla className="gap-6 pb-12">
      <BotonVolver fallback="/temporadas" preferirHistorial={false} etiqueta="Mapa de temporadas" />

      <header className="game-panel overflow-hidden">
        <img
        ...
        />
        <div className="p-6">
          <p className="chapter-label">Capítulo 1 · Misión {mision.orden}</p>
