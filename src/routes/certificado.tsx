...
export const Route = createFileRoute("/certificado")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Reconocimiento digital por completar la Temporada 1: Descubre Santa Cruz.",
      },
      ...
      <Pantalla conNav className="justify-center gap-4 text-center">
        ...
        <div className="mt-2 flex flex-col gap-2 max-w-xs mx-auto w-full">
          ...
          >
            ...
            <span>Ver demostración del certificado (Modo Evaluación)</span>
          </button>
        </div>
      </Pantalla>
    );
    ...
    <Pantalla conNav className="gap-6">
      ...
      <article className="relative overflow-hidden rounded-3xl border-4 border-accent bg-card p-6 text-center shadow-sm">
        ...
        <div className="relative flex flex-col items-center gap-1">
          ...
          <h2 className="text-3xl leading-tight font-extrabold text-primary">
          ...
          <dl className="mt-4 grid w-full grid-cols-3 gap-2 text-center">
            <div className="rounded-xl bg-accent/20 p-3">
              <dt className="text-[10px] text-muted-foreground uppercase">XP</dt>
              <dd className="text-lg font-bold text-foreground">{usuario.xp}</dd>
            </div>
            <div className="rounded-xl bg-accent/20 p-3">
          ...
          <div className="mt-5 w-full border-t border-dashed border-border pt-3 text-[11px] text-muted-foreground">
            ...
            <p className="mt-1 font-mono tracking-wider">
              {codigoCertificado(usuario.nombre, usuario.xp)}
            </p>
          </div>
        </div>
      </article>
      ...
      <p className="text-center text-xs text-muted-foreground">
        Reconocimiento digital de la Temporada 1 · versión de presentación sin validación
        institucional.
      </p>
