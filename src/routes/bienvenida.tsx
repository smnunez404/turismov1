...
export const Route = createFileRoute("/bienvenida")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Asumí el rol de embajador de Santa Cruz: conocer, contar y hacer sentir orgullo.",
      },
...
function Bienvenida() {
  ...
  return (
    <Pantalla className="gap-7 pt-6 text-center">
      <BotonVolver fallback="/login" className="self-start" />
      ...
      <div className="rounded-2xl bg-card p-5 text-left shadow-sm">
        <p className="text-sm font-semibold tracking-wide text-secondary uppercase">Tu nuevo rol</p>
        <p className="mt-2 text-base text-foreground">
          Desde hoy sos <strong>Embajador de Santa Cruz</strong>. No se trata de aprender datos: se
          trata de saber contar tu ciudad a quien llegue, y de sentir orgullo cuando lo hagas.
        </p>
      ...
      <Link to="/tutorial" className="btn-duo btn-duo-primary">
        Ver cómo funciona
      </Link>
    </Pantalla>
  );
