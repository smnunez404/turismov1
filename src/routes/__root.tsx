  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocurrió un inconveniente. Podés intentarlo de nuevo o volver al inicio.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Soy Embajador Bolivia" },
      {
        name: "description",
        content:
          "Juego cultural para descubrir, competir y compartir cuánto conocés Santa Cruz de la Sierra.",
      },
      { name: "author", content: "Adaptive Labs" },
      { property: "og:title", content: "Soy Embajador Bolivia" },
      {
        property: "og:description",
        content: "Jugá desafíos culturales, subí en el ranking y descubrí Santa Cruz de la Sierra.",
      },
