# Documentación — Soy Embajador Bolivia

Base documental viva del proyecto. Compatible con Obsidian: cada archivo es una nota
independiente enlazada.
...
Si algo no está documentado, no está acordado. Todo cambio se registra primero en la
bitácora y recién después se construye.